...
(function() {
  ...
  getComment = function(value) {
    var $, doc, key, line, _i, _len, _ref1;
    doc = {
      texts: []
    };
    _ref1 = value.split(/\n|\r\n?/);
  ...
  generateDoc = function(code, opts, filepath, callback) {
    var comment, data, doc, docs, head, i, idTokens, indent, key, obj, param, prevToken, token, tokens, type, value, _i, _j, _k, _len, _len1, _len2, _ref1;
      ...
      switch (indent) {
        case 0:
          switch (type) {
            case 'HERECOMMENT':
              if (value.charAt(0) === '*') {
                _ref1 = getComment(value.substr(1));
                for (key in _ref1) {
                  value = _ref1[key];
                  head[key] = value;
                }
