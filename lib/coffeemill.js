(function() {
  var CoffeeMill, Deferred, coffee, commander, dateformat, fs, path, pkg, spawn, uglify, util,
  ...
  CoffeeMill = (function() {
    ...
    CoffeeMill.prototype.compile = function() {
      ...
      return Deferred.next(function() {
        ...
        return utils.error('fail phase 1');
        ...
        return util.puts("✔ " + counter + " file" + (counter > 1 ? 's' : '') + " complete.");
      }).error(function(err) {
