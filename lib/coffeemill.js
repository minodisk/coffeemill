(function() {
  var CoffeeMill, Deferred, coffee, colors, commander, dateformat, fs, path, pkg, spawn, uglify, util,
  ...
  CoffeeMill = (function() {
    ...
    CoffeeMill.prototype.run = function() {
      ...
      if (!(this.options.js || this.options.uglify || this.options.coffee || this.options.map)) {
    ...
    CoffeeMill.prototype.scanInput = function() {
      ...
      this.watchers = [];
      this.hasError = false;
      return this.files = this.findFiles(this.options.input, this.options.watch ? this.changed : null);
    };
    ...
    CoffeeMill.prototype.compile = function() {
      ...
      return Deferred.next(function() {
        ...
        var classFiles, className, classNames, code, codes, counter, cwd, data, exp, exports, ext, extendsClassName, file, filename, i, j, js, len, map, name, namespace, normalFiles, outputDir, outputPath, outputs, packageNamespace, packages, postfix, resolvedFiles, type, uglified, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _len7, _m, _n, _o, _p, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
        if (version !== '') {
