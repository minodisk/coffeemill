...
(function() {
  ...
  CoffeeMill = (function() {
    ...
    CoffeeMill.prototype.findFiles = function(dirs, change, basedir, files) {
      var childs, className, code, dir, dirPath, extendsName, extname, file, filePath, i, isBasedir, name, namespace, namespaces, packages, r, stats, _i, _j, _len, _len1;
    ...
    CoffeeMill.prototype.compile = function() {
      ...
      return Deferred.next(function() {
        ...
        var className, code, codes, exp, exports, filename, k, name, namespace, output, outputDir, packages, pkg, postfix, v, v3SourceMap, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2, _ref3;
