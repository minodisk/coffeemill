  ...
  CoffeeMill = (function() {
    ...
    CoffeeMill.prototype.compile = function() {
      ...
      return Deferred.next(function() {
        ...
        var a, b, className, code, codes, cs, data, exp, exports, filename, files, i, j, js, k, map, name, namespace, outputDir, outputPath, outputs, packages, pkg, postfix, type, uglified, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref, _ref1, _ref2, _ref3, _ref4;
        ...
        while (i--) {
          a = _this.files[i];
          if ((a.className == null) || (a.extendsClassName == null)) {
            files.unshift(a);
            continue;
          }
          for (j = _i = 0, _len = files.length; _i < _len; j = ++_i) {
            b = files[j];
          ...
          j = files.length;
          while (j--) {
            if (b.className === a.extendsClassName) {
        ...
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          _ref1 = _ref[_j], code = _ref1.code, name = _ref1.name, className = _ref1.className, packages = _ref1.packages, namespace = _ref1.namespace;
          codes.push(code);
          exp = exports;
        ...
        for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
          ...
          for (_m = 0, _len4 = outputs.length; _m < _len4; _m++) {
            _ref4 = outputs[_m], type = _ref4.type, filename = _ref4.filename, data = _ref4.data;
