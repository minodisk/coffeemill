  ...
  CoffeeMill = (function(_super) {
    ...
    CoffeeMill.prototype.compile = function() {
      ...
      Deferred.next(function() {
        ...
        return _this.emit('fail', 'fail to fetch version');
        ...
        if (err.location != null) {
          ...
          return _this.emit('fail', "" + err.stack);
        }
      });
      return this;
    };
    ...
    CoffeeMill.prototype.reportCompileError = function(csName, cs, err) {
      ...
      if (err.location != null) {
        ...
        this.emit('fail', "" + csName + ":" + first_line + ":" + first_column + "\n" + (lineNumber + '.') + code + "\n" + (nextLineNumber + '.') + mark);
      } else {
        this.emit('fail', "CoffeeScript Compiler\n" + err);
      }
