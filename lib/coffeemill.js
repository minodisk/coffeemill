  ...
  CoffeeMill = (function() {
    ...
    CoffeeMill.prototype.compile = function() {
      ...
      return Deferred.next(function() {
        ...
        var className, code, codes, exp, exports, extendsName, extname, file, filePath, filename, files, name, output, packageName, packages, pkg, postfix, r, v3SourceMap, _i, _j, _k, _len, _len1, _len2, _ref, _ref1, _ref2;
        ...
        code = codes.join('\n\n');
        output = path.join(_this.cwd, commander.output);
