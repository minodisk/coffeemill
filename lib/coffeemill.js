    ...
    Relay.serial(Relay.func(function() {
      ...
      if (opts.join != null) {
        return Relay.serial(Relay.func(function(files) {
          ...
          var code, counter, d, detail, details, displace, i, internal, sorted, tmp, _i, _j, _k, _l, _len, _len2, _len3, _len4, _len5, _len6, _len7, _m, _n, _o;
          ...
          while (i = details.length) {
            ...
            while (i--) {
              ...
              if (detail.depends == null) {
                ...
                for (_l = 0, _len4 = sorted.length; _l < _len4; _l++) {
                  d = sorted[_l];
                  if (detail.depends === d["class"]) {
                    displace = true;
                    break;
          ...
          code = "";
          if (opts.bare != null) {
            for (_n = 0, _len6 = details.length; _n < _len6; _n++) {
              detail = details[_n];
              code += detail.code;
            }
          } else {
            for (_o = 0, _len7 = details.length; _o < _len7; _o++) {
              detail = details[_o];
              code += "" + detail.code + "\n";
            }
          }
