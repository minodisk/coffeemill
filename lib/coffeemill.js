  ...
  CoffeeMill = (function() {
    ...
    CoffeeMill.prototype.compile = function() {
      ...
      return Deferred.next(function() {
        ...
        var classFiles, className, classNames, code, codes, data, exp, exports, extendsClassName, file, filename, i, j, js, k, map, name, namespace, normalFiles, outputDir, outputPath, outputs, packages, pkg, postfix, resolvedFiles, type, uglified, v, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
        if (version !== '') {
